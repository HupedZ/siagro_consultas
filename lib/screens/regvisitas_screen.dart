...
class _RegistrarVisitasScreenContent extends StatelessWidget {
  ...
  final GlobalKey<_RegistrarVisitasFormState> _formKey =
      GlobalKey<_RegistrarVisitasFormState>();
...
class _RegistrarVisitasFormState extends State<_RegistrarVisitasForm> {
  ...
  final ValueNotifier<String> tipoSeleccionado =
      ValueNotifier<String>('Maquinaria');
  final ValueNotifier<DateTime?> proximaFechaSeleccionada =
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  if (proxima == null) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                          content: Text('Debe seleccionar la próxima fecha')),
                    );
                    return;
                  }
